...
extern "C" {
    ...
    // Take-Agency local patch: variants that gate CoreML encoder loading at runtime.
    // Pass use_coreml=false to skip CoreML and run CPU/Metal-only even when WHISPER_USE_COREML is compiled in.
